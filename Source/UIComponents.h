...
namespace Colors
{
    constexpr juce::Colour bgDark(0xFF1A1A1E);
    constexpr juce::Colour bgPanel(0xFF222226);
    constexpr juce::Colour bgLight(0xFF2A2A2E);
    constexpr juce::Colour bgLighter(0xFF323236);
    
    constexpr juce::Colour accentPurple(0xFF7B2D8E);
    constexpr juce::Colour accentBlue(0xFF2D5A8E);
    constexpr juce::Colour accentTeal(0xFF2D8E8E);
    constexpr juce::Colour accentGreen(0xFF2D8E5A);
    constexpr juce::Colour accentOrange(0xFF8E5A2D);
    constexpr juce::Colour accentPink(0xFF8E2D5A);
    
    constexpr juce::Colour textPrimary(0xFFE0E0E0);
    constexpr juce::Colour textSecondary(0xFF909090);
    constexpr juce::Colour textDim(0xFF505050);
    constexpr juce::Colour textBright(0xFFFFFFFF);
    
    constexpr juce::Colour shadowColor(0x80000000);
    constexpr juce::Colour knobTrack(0xFF3A3A3E);
    constexpr juce::Colour knobFill(0xFF7B2D8E);
    constexpr juce::Colour toggleOn(0xFF7B2D8E);
    constexpr juce::Colour toggleOff(0xFF3A3A3E);
}

// Custom rotary knob with shadow and glow
...
// Toggle button with custom look
...
// Section panel with shadow and title
